...
--
-- Host: localhost
-- Generation Time: Dec 22, 2013 at 12:41 AM
...
CREATE TABLE IF NOT EXISTS `downs` (
  ...
  `gameClockAfterPlay` time NOT NULL,
...
INSERT INTO `downs` (`downID`, `downQuarter`, `downNumber`, `teamWithBall`, `ballOn`, `yardsToGo`, `gameClockAfterPlay`, `matchupID`) VALUES
(1, '1st', 1, 1, 35, 10, '00:13:24', 1),
(2, '1st', 2, 1, 40, 5, '00:13:20', 1),
(3, '1st', 1, 1, 60, 10, '00:13:01', 1);
...
--
-- Dumping data for table `entityperformance`
--

INSERT INTO `entityperformance` (`performanceID`, `entityID`, `downID`) VALUES
(1, 2, 1),
(2, 1, 2);
...
INSERT INTO `passing` (`passingID`, `intededReceiverID`, `passCompleted`, `performanceID`) VALUES
(1, 1, 'true', 1);
...
INSERT INTO `receiving` (`receivingID`, `performanceID`) VALUES
(1, 2);
